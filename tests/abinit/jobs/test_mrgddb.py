def test_mrgddb_silicon_carbide_standard(mock_mrgddb, abinit_test_dir, clean_dir):
    import os
    ...
    test_dir = (
        abinit_test_dir / "jobs" / "mrgddb" / "MrgddbMaker" / "silicon_carbide_standard"
    )
    ...
    assert isinstance(output1, MrgddbTaskDoc)
