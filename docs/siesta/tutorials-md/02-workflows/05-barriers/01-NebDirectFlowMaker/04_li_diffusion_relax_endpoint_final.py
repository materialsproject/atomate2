...
# =============================================================================
# Example 3: Relax only final structure (initial is known state)
# =============================================================================
maker = NebDirectFlowMaker(
    dry_run=False,
    number_of_images=5,
    relax_endpoints="final",  # Only relax final structure
...
# Run the workflow
results = run_locally(
    flow, create_folders=True, root_dir="04_li_diffusion_relax_endpoint_final"
)
