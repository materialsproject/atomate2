...
flow_maker = AdsorptionScanFlowMaker(
    ...
    grid_size=(3, 3),  # 2×2 grid of adsorption sites
    # height=2.0,  # Adsorbate height above surface (Å)
    heights=[1.0, 1.5, 2.0],  # [1.5, 2.0, 2.5, 3.0],  # Explicit list
...
results = run_locally(workflow, create_folders=True, root_dir="11_height_scanning_tier")
