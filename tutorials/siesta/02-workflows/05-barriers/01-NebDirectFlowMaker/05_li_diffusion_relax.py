...
# =============================================================================
# Example 4: Different relaxation settings for each endpoint (NEW!)
# =============================================================================
# Use case: Initial state needs quick relaxation, final state needs precise
maker = NebDirectFlowMaker(
    dry_run=False,
    number_of_images=5,
    relax_endpoints=True,  # Relax both
...
# Run the workflow
results = run_locally(flow, create_folders=True, root_dir="05_li_diffusion_relax")
