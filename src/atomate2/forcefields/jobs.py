...
@deprecated(
    replacement=ForceFieldRelaxMaker,
    deadline=(2025, 1, 1),
    message="To use DeepMD, set `force_field_name = 'DeepMD'` in ForceFieldRelaxMaker.",
)
@dataclass
class DeepMDRelaxMaker(ForceFieldRelaxMaker):
    """
    Base Maker to calculate forces and stresses using a Deep Potential (DP) model.
...
class DeepMDStaticMaker(ForceFieldStaticMaker):
    """
    Base Maker to calculate forces and stresses using a DeepPotential (DP) model.
