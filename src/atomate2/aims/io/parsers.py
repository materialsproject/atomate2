...
#         if line_start == LINE_NOT_FOUND:
#             raise AimsParseError("This file does not appear to be an aims-output")
...
#                 atoms.append(
#                     Atom(
#                         line_split[4], tuple([float(inp) for inp in line_split[1:4]])
#                     )
#                 )
...
#             spins = [
#                 int("Spin-down eigenvalues:" in self.lines[ll]) for ll in spin_def
#             ]
...
#            f"The requested output file {filename} does not exist."
#         )
