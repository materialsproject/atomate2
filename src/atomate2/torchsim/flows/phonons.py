...
class PhononMaker(BasePhononMaker):
    ...
    bulk_relax_maker : .TorchSimOptimizeMaker or None
        A maker to perform a tight relaxation on the bulk.
        Set to ``None`` to skip the
        bulk relaxation
    static_energy_maker : .TorchSimStaticMaker or None
        A maker to perform the computation of the DFT energy on the bulk.
        Set to ``None`` to skip the
        static energy computation
    born_maker: .TorchSimStaticMaker or None
        Maker to compute the BORN charges.
    phonon_displacement_maker : .TorchSimStaticMaker or None
