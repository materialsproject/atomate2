...
lattice = np.array([[22.6767599999999980, 0, 0],
...
atoms = ['O', 'H', 'H']
coords = [[0.480785272057,0.492689037759,0.47474985113],
          [0.544367024943,0.540886680214,0.475393875341],
          [0.474847703,0.466424282027,0.549856273529]]
temp = list(zip(atoms, coords))
ion_dict = [{'species-id': atoms[i], 'x0': coords[i][0], 'x1': coords[i][1], 'x2': coords[i][2], 'moveScale': 1} for i in range(len(atoms))]
water_tagdict = {
