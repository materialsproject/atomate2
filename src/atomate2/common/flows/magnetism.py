...
from typing import TYPE_CHECKING, Dict, Literal, Optional, Sequence
...
class MagneticOrderingsMaker(Maker):
    ...
    static_maker : Maker
        Maker used to peform static calculations for total energy (e.g., atomate2.vasp.jobs.StaticMaker).
    relax_maker : Maker | None
        Maker used to perform relaxations of the enumerated structures (e.g.,
        atomate2.vasp.jobs.RelaxMaker). If None, relaxations will be skipped (i.e., only static calculations).
    ...
    strategies : tuple
        ...
        antiferromagnetic_by_motif, ferrimagnetic_by_motif,
        ferrimagnetic_by_species, or nonmagnetic. Here, "motif", means to use a different ordering
